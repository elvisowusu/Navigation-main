    ...
    return(
        <div className="h-screen">
            ...
            <div className="flex flex-col items-center">
                ...
                <p className="text-center md:text-left text-[1.2rem] w-[22rem]">Get your team in sync, no matter your location. Streamline processes, create team rituals, and watch productivity soar.</p>
