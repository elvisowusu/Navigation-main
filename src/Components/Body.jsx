...
export const Body =()=>{
    ...
    return(
        <div className="flex flex-col lg:flex-row-reverse lg:items-center lg:justify-between lg:h-[89vh] lg:px-[3rem] xl:px-[15rem] lg:py-[27rem] xl:py-[9rem]">
            <div >{state.width > 1024 ? <img className="lg:w-[31.25rem] xl:w-[34rem] xl:ml-3" src={desktop} alt="destop img" />:<img className="md:w-full" src={mobile} alt="destop img"/>}</div>
