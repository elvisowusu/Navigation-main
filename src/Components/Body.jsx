...
export const Body =()=>{
    ...
    return(
        <div className="flex flex-col lg:flex-row-reverse lg:items-center lg:justify-between lg:h-[89vh] lg:px-[3rem] lg:py-[27rem]">
            <div >{state.width > 1024 ? <img src={desktop} alt="destop img" width={500}/>:<img className="md:w-full" src={mobile} alt="destop img"/>}</div>
            <div className="flex flex-col items-center lg:items-start">
                <h1 className={`text-[2.5rem] sm:text-[5rem] md:text-[6.5rem] lg:leading-[5rem] lg:w-[36rem] font-extrabold text-AlmostBlack mt-[2rem] sm:mt-[1.5rem]`}>Make remote work</h1>
                ...
                <div className={`flex items-center justify-between w-[22rem] sm:w-[36rem] md:w-[50rem] lg:w-[30rem] mt-[2rem] sm:mt-[1.5rem] sm:mb-[2rem] lg:mb-0`}>
                    {
                        image.map((image,key)=>{
