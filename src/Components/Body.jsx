...
export const Body =()=>{
    ...
    return(
        <div className="flex flex-col lg:flex-row-reverse lg:items-center lg:justify-between lg:h-[89vh] lg:px-[3rem] xl:px-[15rem] lg:py-[27rem] xl:pt-0 xl:pb-[3rem]">
            <div >{state.width > 1024 ? <img className="lg:w-[31.25rem] xl:w-[34rem]" src={desktop} alt="destop img" />:<img className="md:w-full" src={mobile} alt="destop img"/>}</div>
            <div className="flex flex-col items-center lg:items-start lg:mt-[5.5rem] xl:mt-[7.6rem]">
                <h1 className={`text-[2.5rem] sm:text-[5rem] md:text-[6.5rem] lg:leading-[5rem] lg:w-[36rem] font-extrabold text-AlmostBlack mt-[2rem] sm:mt-[1.5rem] lg:mb-[2.5rem] xl:mb-[2.8rem]`}>Make remote work</h1>
