...
export const Body =()=>{
    ...
    return(
        <div className="flex flex-col lg:flex-row-reverse lg:items-center lg:justify-between lg:h-[89vh] lg:px-[3rem] xl:px-[15rem] lg:py-[27rem] xl:py-[10rem] xl:gap-[1rem]">
